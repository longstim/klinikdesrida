...
@section('page_heading','Laporan Pasien Berobat')
@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
  <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
  <li class="breadcrumb-item active">Laporan Pasien Berobat</li>
</ol>
@endsection
@section('content')
<style>
  ...
  <div class="row">
    ...
    <div class="col-12">
     <form role="form" id="searchTanggalBerobat" method="post" action="{{url('cariLaporanPasienBerobat')}}" >
        {{ csrf_field() }}
    ...
    <div class="col-sm-12">
        <p><i>Jumlah pasien dari tanggal {{$tanggalDari}} sampai dengan {{$tanggalSampai}} adalah sebanyak : <b>{{jumlahPasien($tanggalDari, $tanggalSampai)}} orang</b></i></p>
    </div>
